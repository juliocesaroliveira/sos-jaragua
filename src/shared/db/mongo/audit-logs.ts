 ...
 * - `Habilidade` → `habilidade` (017-gestao-habilidades: cadastro/edição/exclusão)
 */
export const ENTIDADES_AUDITADAS = ['Voluntario', 'Atividade', 'Doacao', 'Usuario', 'Habilidade'] as const
